...
**Live:** [https://relaxed-weasel-textgen.cloud.nexlayer.ai](https://relaxed-weasel-textgen.cloud.nexlayer.ai)  
...
**textgen** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/atinoda/text-generation-webui:default-cpu
    path: /
    servicePorts:
    - 7860
    volumes:
